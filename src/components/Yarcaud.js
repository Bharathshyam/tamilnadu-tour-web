            ...
            <div className='container'>
                ...
                <div className='row'>
                    <div className='col-lg-6 col-12'>
                        <img src={require('../Home/yercaud1.(4).jpeg')} alt='chennai' className='img-fluid'/>
                    </div>
                ...
                <div className='row'>
                    <div className="card col-lg-3 col-6" >
                        <img src={require('../Home/yercaud...(1).jpeg')} class="card-img-top" alt="chennai1"/>
                                <div className="card-body">
                                    <h5 className="card-title">Pogada Point</h5>
                    ...
                    <div className="card col-lg-3 col-6" >
                        <img src={require('../Home/yercaud1 (2).jpeg')} class="card-img-top" alt="chennai1"/>
                                <div className="card-body">
                    ...
                    <div className="card col-lg-3 col-6" >
                        <img src={require('../Home/yercaud1.(3).jpeg')} class="card-img-top" alt="chennai1"/>
                                <div className="card-body">
                    ...
                    <div className="card col-lg-3 col-6" >
                        <img src={require('../Home/yercaud1 (4).jpeg')} class="card-img-top" alt="chennai1"/>
                                <div className="card-body">
