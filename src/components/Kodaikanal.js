            ...
            <div className='container'>
                ...
                <div className='row'>
                    <div className='col-lg-6 col-12'>
                        <img src={require('../Home/Kodaikanal.jpeg')} alt='kodaikanal' className='img-fluid'/>
                    </div>
                ...
                <div className='row'>
                    <div className="card col-lg-3 col-6" >
                        <img src={require('../Home/kodaikanal1....jpeg')} class="card-img-top" alt="chennai1"/>
                    ...
                    <div className="card col-lg-3 col-6" >
                        <img src={require('../Home/kodaikanal2.jpeg')} class="card-img-top" alt="chennai1"/>
                                <div className="card-body">
                    ...
                    <div className="card col-lg-3 col-6" >
                        <img src={require('../Home/kodaikanal3..jpeg')} class="card-img-top" alt="chennai1"/>
                                <div className="card-body">
                    ...
                    <div className="card col-lg-3 col-6" >
                        <img src={require('../Home/kodaikanal4.jpeg')} class="card-img-top" alt="chennai1"/>
                                <div className="card-body">
                                    <h5 className="card-title">Piller Rocks</h5>
                                    <p className="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                                    <Button className='btn'>Read More</Button>
                                </div>
                    </div>
